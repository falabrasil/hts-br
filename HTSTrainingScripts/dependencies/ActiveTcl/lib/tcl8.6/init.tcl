...
#
# ActiveState ActiveTcl 8.6.7.0 Linux/x86_64, Fri Nov 24 02:19:54 MST 2017
#
...
namespace eval ::activestate {
	...
	buildtime,sec {1511489994}
	buildtime,fmt {Fri Nov 24 02:19:54 MST 2017}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.6.7.0 Linux/x86_64 @ Fri Nov 24 02:19:54 MST 2017 6c53c071ed1a2dc3ced52bdbdd87714231aecf32 / normal}
    }
}

package provide {ActiveTcl} {8.6.7.0}
